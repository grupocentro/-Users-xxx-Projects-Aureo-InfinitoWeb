...
export default function AdminSelector() {
  ...
  useEffect(() => {
    ...
    // Staff (control_entradas) salta directo a scanner: no necesita el selector.
    if (isStaff && !isAdmin) {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-water-50 via-app-bg to-water-100">
      {/* Decoración ambiental - olas/burbujas suaves */}
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute bottom-0 left-1/4 h-80 w-80 rounded-full bg-water-100/60 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        ...
        <div className="flex flex-1 flex-col items-center justify-center px-6 pb-12">
          <div className="mb-10 max-w-2xl text-center">
            <p className="mb-2 text-sm font-medium uppercase tracking-[0.2em] text-water-600">
              Bienvenido
            </p>
          ...
          <div className="grid w-full max-w-4xl gap-5 sm:grid-cols-2">
            ...
            >
              <div className="pointer-events-none absolute -right-10 -top-10 h-40 w-40 rounded-full bg-gradient-to-br from-water-200 to-water-400 opacity-30 blur-2xl transition-opacity duration-300 group-hover:opacity-50" />
              <div className="relative">
                <div className="mb-5 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-water-300 to-water-500 shadow-lg shadow-water-400/40">
                  <FileText className="h-7 w-7 text-white" />
                </div>
                <h2 className="mb-2 text-2xl font-bold text-water-800">Panel Web</h2>
                <p className="mb-6 text-sm leading-relaxed text-app-muted">
                  Administrá el contenido público del parque: imágenes, noticias, promociones, eventos, atracciones y comunicación visual.
                </p>
            ...
            {isAdmin ? (
              <button
                ...
                className="group relative overflow-hidden rounded-3xl border border-white/60 bg-white/70 p-7 text-left shadow-xl shadow-water-500/10 backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:shadow-water-500/20"
              >
                <div className="pointer-events-none absolute -right-10 -top-10 h-40 w-40 rounded-full bg-gradient-to-br from-water-500 to-water-800 opacity-30 blur-2xl transition-opacity duration-300 group-hover:opacity-50" />
                <div className="relative">
                  <div className="mb-5 inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-water-600 to-water-800 shadow-lg shadow-water-700/40">
                    <Activity className="h-7 w-7 text-white" />
                  </div>
                  <h2 className="mb-2 text-2xl font-bold text-water-800">Panel Ticketera</h2>
                  <p className="mb-6 text-sm leading-relaxed text-app-muted">
                    Controlá ventas, entradas, QR, validaciones, reportes, cobros y operación diaria del parque.
                  </p>
                  <div className="flex items-center gap-1.5 text-sm font-semibold text-water-600 transition-transform duration-300 group-hover:translate-x-1">
                    Ingresar al Panel Ticketera
                    <ArrowRight className="h-4 w-4" />
                  </div>
                </div>
              </button>
              ...
              >
                ...
                <h2 className="mb-2 text-2xl font-bold text-app-muted">Panel Ticketera</h2>
                <p className="mb-6 text-sm leading-relaxed text-app-muted">
                  Controlá ventas, entradas, QR, validaciones, reportes, cobros y operación diaria del parque.
                </p>
